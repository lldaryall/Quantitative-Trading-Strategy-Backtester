...
class TestDownloadWithRetry:
    ...
    def test_download_success_first_attempt(self, mock_ticker_class):
        ...
        assert len(result) == 1
        mock_ticker.history.assert_called_once_with(start='2023-01-01', end='2023-01-02', interval='1d')
    ...
    def test_download_retry_on_failure(self, mock_sleep, mock_ticker_class):
        ...
        result = _download_with_retry('AAPL', '2023-01-01', '2023-01-02', '1d', max_retries=3)
    ...
    def test_download_all_retries_fail(self, mock_ticker_class):
        ...
        with pytest.raises(DataError, match="Failed to download data.*after 3 attempts"):
            _download_with_retry('INVALID', '2023-01-01', '2023-01-02', '1d', max_retries=3)
...
class TestValidateAndProcessData:
    ...
    def test_validate_missing_columns_raises_error(self):
        ...
        with pytest.raises(DataError, match="Missing required columns"):
            _validate_and_process_data(incomplete_data, 'AAPL', '2023-01-01', '2023-01-02')
    ...
    def test_validate_processes_data_correctly(self):
        ...
        raw_data = pd.DataFrame({
            ...
            'Close': [102, 103, 104],
            'Volume': [1000, 1100, 1200]
        }, index=pd.date_range('2023-01-03', periods=3))  # Unsorted dates
        
        result = _validate_and_process_data(raw_data, 'AAPL', '2023-01-01', '2023-01-05')
    ...
    def test_validate_drops_all_nan_rows(self):
        ...
        result = _validate_and_process_data(data_with_nans, 'AAPL', '2023-01-01', '2023-01-03')
...
class TestYahooFinanceProvider:
    ...
    def test_yahoo_finance_provider_calls_get_price_data(self, mock_get_price_data):
        ...
        mock_get_price_data.assert_called_once_with('AAPL', '2023-01-01', '2023-01-03', '1d')
