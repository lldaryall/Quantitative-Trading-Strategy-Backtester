...
def calculate_position_sizes(
    ...
    portfolio_df["portfolio_value"] = (
        portfolio_df["cash"] + portfolio_df["position"] * portfolio_df["close"]
    )

    return portfolio_df


def backtest_strategy(price_df: pd.DataFrame, params: StrategyParams) -> pd.DataFrame:
    """
    ...
    portfolio_df = calculate_position_sizes(
        signals_df, params.initial_cash, params.fee_bps, params.slippage_bps
    )
