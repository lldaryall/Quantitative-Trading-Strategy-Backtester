...
class TestStrategyParams:
    ...
    def test_invalid_cash(self):
        ...
        with pytest.raises(ValueError, match="initial_cash must be positive"):
            StrategyParams("AAPL", "2023-01-01", "2023-12-31", 10, 20, initial_cash=-1000)
...
class TestGenerateSignals:
    ...
    def test_basic_signal_generation(self):
        ...
        prices = [100, 101, 102, 103, 104, 105, 104, 103, 102, 101, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109]
    ...
    def test_no_look_ahead_bias(self):
        ...
        prices = [100, 100, 100, 100, 100, 101, 102, 103, 104, 105]  # Clear uptrend starts day 6
    ...
    def test_synthetic_crossover_scenario(self):
        ...
        prices = [100, 100, 100, 100, 100, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109]
    ...
    def test_first_tradable_signal_timing(self):
        ...
        prices = [100, 100, 100, 100, 100, 100, 100, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112]
...
class TestCalculatePositionSizes:
    ...
    def test_basic_position_calculation(self):
        ...
        pd.testing.assert_series_equal(result['position'], signals_df['signal'], check_names=False)
        ...
        pd.testing.assert_series_equal(signal_changes, position_changes, check_names=False)
    
    def test_missing_columns(self):
        """Test error when required columns are missing."""
        df = pd.DataFrame({'close': [100, 101, 102]})
        
        with pytest.raises(ValueError, match="signals_df must contain 'signal' and 'close' columns"):
...
class TestBacktestStrategy:
    ...
    def test_basic_backtest(self):
        ...
        expected_columns = ['close', 'sma_fast', 'sma_slow', 'crossover', 'signal', 
                          'position', 'cash', 'portfolio_value', 'trade_cost']
...
class TestGetStrategyMetrics:
    ...
    def test_basic_metrics(self):
        ...
        portfolio_df = pd.DataFrame({
            'portfolio_value': [10000, 10100, 10200, 10150, 10100, 10200, 10300, 10250, 10200, 10300]
        }, index=dates)
        ...
        expected_metrics = ['total_return', 'annualized_return', 'volatility', 
                          'sharpe_ratio', 'max_drawdown', 'total_trades', 'final_value']
    ...
    def test_missing_portfolio_value_column(self):
        ...
        with pytest.raises(ValueError, match="portfolio_df must contain 'portfolio_value' column"):
