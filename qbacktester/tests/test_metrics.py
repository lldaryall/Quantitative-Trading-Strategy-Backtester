...
class TestDailyReturns:
    ...
    def test_basic_daily_returns(self):
        ...
        equity_curve = pd.Series([100, 101, 102, 103, 104], 
    ...
    def test_negative_values(self):
        ...
        with pytest.raises(ValueError, match="equity_curve must contain only positive values"):
    ...
    def test_single_value(self):
        ...
        equity_curve = pd.Series([100], index=pd.date_range('2023-01-01', periods=1, freq='D'))
...
class TestCAGR:
    ...
    def test_basic_cagr(self):
        ...
        equity_curve = pd.Series([100, 110], index=pd.date_range('2023-01-01', periods=2, freq='D'))
        
        cagr_value = cagr(equity_curve, periods_per_year=1)  # Use 1 period per year for 1-day growth
    ...
    def test_cagr_with_more_periods(self):
        ...
        days = 252
        equity_curve = pd.Series([100] + [100 * (1.01 ** i) for i in range(1, days + 1)],
...
class TestSharpe:
    ...
    def test_all_nan_series(self):
        ...
        with pytest.raises(ValueError, match="returns must contain at least one non-NaN value"):
...
class TestMaxDrawdown:
    ...
    def test_basic_max_drawdown(self):
        ...
        equity_curve = pd.Series([100, 110, 105, 120, 115, 130],
...
class TestRealisticData:
    ...
    def test_constant_series_metrics(self):
        ...
        equity_curve = pd.Series([100] * 100, index=pd.date_range('2023-01-01', periods=100, freq='D'))
...
class TestGetAllMetrics:
    ...
    def test_basic_get_all_metrics(self):
        ...
        equity_curve = pd.Series([100, 101, 102, 101, 103, 104, 102, 105],
        ...
        expected_metrics = [
            'cagr', 'sharpe', 'sortino', 'volatility', 'calmar', 'hit_rate',
            'avg_win', 'avg_loss', 'var_5pct', 'cvar_5pct', 'max_drawdown',
